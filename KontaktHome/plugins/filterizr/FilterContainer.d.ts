/// 
//import { RawOptionsCallbacks } from '../filterizr/FilterizrOptions/defaultOptions';
import { RawOptionsCallbacks } from '../../plugins/filterizr/types/interfaces';
import FilterizrOptions from '../../plugins/filterizr/FilterizrOptions/FilterizrOptions';
import FilterItems from '../../plugins/filterizr/FilterItems';
/**
